...
public class AutoSuggestAdapter extends RecyclerView.Adapter<AutoSuggestAdapter.MyViewholder> {
    ...
    public void onBindViewHolder(@NonNull MyViewholder holder, final int position) {
        ...
        holder.viewaddress.setText(list.get(position).placeAddress);

        holder.name_place.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    class MyViewholder extends RecyclerView.ViewHolder {
        ...
        LinearLayout name_place;

        public MyViewholder(View itemView) {
            super(itemView);
            viewName = itemView.findViewById(R.id.textView);
            viewaddress=itemView.findViewById(R.id.textView1);
